...
<body class="bg-[#FAFAFB] text-gray-800 flex flex-col min-h-screen">
    ...
    <main class="flex-grow flex items-center justify-center py-20 px-6">
        <div class="text-center max-w-lg">
            ...
            <a href="<?= base_url('index') ?>" class="inline-flex items-center gap-2 bg-[#E88D57] hover:bg-[#D97C45] text-white font-bold py-3.5 px-8 rounded-full transition-all shadow-md hover:shadow-lg">
