...
<body class="bg-[#FAFAFB] font-sans h-screen flex items-center justify-center p-4 relative">
    ...
    <a href="<?= base_url('index') ?>" class="absolute top-6 left-6 md:top-8 md:left-8 w-12 h-12 bg-white border border-gray-200 rounded-full flex items-center justify-center text-gray-500 hover:text-brand-orange hover:shadow-md transition-all z-50 group">
