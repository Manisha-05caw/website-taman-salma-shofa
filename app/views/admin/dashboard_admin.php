...
<form action="" method="GET" class="relative w-[140px] sm:w-[200px] md:w-[300px]">
            ...
            <div class="flex items-center gap-4 md:gap-6">
                <div class="hidden lg:flex items-center gap-3">
                    <a href="<?= base_url('') ?>" target="_blank" class="text-[12px] font-bold text-gray-600 bg-gray-100 hover:bg-gray-200 px-4 py-2.5 rounded-lg transition-colors"><i class="fa-solid fa-globe"></i> Lihat Website</a>
